...
<script type="text/javascript">
	...
	function doDelete(){
		$.messager.confirm('确认信息','确认删除数据吗?',function(r) {
			if(r){
				...
				var ids = array.join(",");
				window.location.href="${pageContext.request.contextPath}/subareaAction_delete?ids="+ids;
			}
		});
	...
	function doExport(){
		window.location.href="${pageContext.request.contextPath}/subareaAction_exportExcel";
	}
	...
	$(function(){
		$("#button-import").upload({
			action:"${pageContext.request.contextPath}/subareaAction_importExcel",
			name:"myfile",
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="分区添加" id="addSubareaWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div style="overflow:auto;padding:5px;" border="false">
			<form id="subareaForm" action="${pageContext.request.contextPath }/subareaAction_save" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>选择区域</td>
						<td>
							<input class="easyui-combobox" name="region.id"  required="true"
    							data-options="valueField:'id',textField:'name', mode:'remote',
    							url:'${pageContext.request.contextPath }/regionAction_ajaxList4subareas.action'" />  
						</td>
					</tr>
					<tr>
						<td>关键字</td>
