...
<script type="text/javascript">
	...
	function doDelete(){
		...
		if(row == 0) {
			$.messager.alert('提示信息','未选中任何数据!','warning');
		} else {
		var array = new Array();
		...
		$("#button-import").upload({
			...
			onComplete:function(data){
				if(data == 1){
					...
					$.messager.alert('警告信息','上传失败','warning');
				}
			}
		});
	});
	...
	$(function(){
		$("#save").click(function(){
			flag = $("#saveRegionForm").form("validate");
			if(flag){
	...
	$(function(){
		$("#edit").click(function(){
			flag = $("#editRegionForm").form("validate");
			if(flag){
...
<body class="easyui-layout" style="visibility:hidden;">
	...
	<div class="easyui-window" title="区域添加修改" id="addRegionWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="saveRegionForm" action="${pageContext.request.contextPath }/regionAction_save">
	...
	<div class="easyui-window" title="区域添加修改" id="editRegionWindow" collapsible="false" minimizable="false" maximizable="false" style="top:20px;left:200px">
		...
		<div region="center" style="overflow:auto;padding:5px;" border="false">
			<form id="editRegionForm" action="${pageContext.request.contextPath }/regionAction_edit">
				<table class="table-edit" width="80%" align="center">
					<tr class="title">
						<td colspan="2">区域信息</td>
					</tr>
