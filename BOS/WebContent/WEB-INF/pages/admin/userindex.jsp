...
<body class="easyui-layout" style="visibility:hidden;">
    <div region="east" title="查询条件" icon="icon-forward" style="width:180px;overflow:auto;" split="false" border="true" >
		...
		<form id="form" method="post" action="${pageContext.request.contextPath}/userAction_pageQuery">
			<table class="table-edit" width="100%" >				
				...
				<tr><td>
					<b>姓名</b><span class="operator"><a name="name-opt" opt="all"></a></span>
